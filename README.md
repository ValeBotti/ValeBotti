...
<img src="./images/kitty.png" width="50" height="50" alt="Kitty Icon"> Currently, I'm improving my old Kotlin application and learning ASP.NET Core Web API basics; you can have a look if you like.

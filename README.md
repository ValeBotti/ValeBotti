...
<img src="./images/kitty.png" width="30" height="30" alt="Kitty Icon"> Currently, I'm improving my old Kotlin application and learning ASP.NET Core Web API basics; you can have a look if you like.
